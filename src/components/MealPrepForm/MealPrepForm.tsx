...
import type { MealPrepFormProps } from './MealPrepForm.types'
...
export default function MealPrepForm({ data, errors, isSaving, onBlur, onCancel, onChange, onSave, onTagRemove, onTagSelect, selectedTags, serverError }: MealPrepFormProps) {
  return (
